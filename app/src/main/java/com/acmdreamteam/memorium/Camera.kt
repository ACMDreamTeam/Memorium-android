...
class Camera : AppCompatActivity() {
    ...
    lateinit var camera_change: Button
    lateinit var camera_save: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        camera_save = findViewById(R.id.camera_save)

        // Check camera permissions if all permission granted
        // start camera else ask for the permission
        if (allPermissionsGranted()) {
            startCamera(cameraSelector = CameraSelector.DEFAULT_FRONT_CAMERA)
        ...
        imageCapture.takePicture(
                ...
                object : ImageCapture.OnImageSavedCallback {
                    ...
                    override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                        ...
                        camera_capture.visibility = View.GONE
                        camera_change.visibility = View.GONE
                        camera_save.visibility = View.VISIBLE
